    ...
    (err) => {
      ...
      db.query(
        ...
        (err, results) => {
          ...
          const message =
            action === "accepted"
              ? "Welcome aboard! Your application has been accepted."
              : "Unfortunately, your application was not successful this time.";
          const accentColor = action === "accepted" ? "#16a34a" : "#dc2626";
          ...
          transporter.sendMail(
            ...
            (error) => {
              ...
              sendSuccess(
                res,
                `Student ${action} and email notification sent.`
              );
            }
          );
        }
